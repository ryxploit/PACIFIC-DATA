...
Public Class ReportBECARIO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PACIFIC_DATA.ReportBECARIO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportBECARIO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportBECARIO = New ReportBECARIO()
        rpt.Site = Me.Site
        Return rpt
    End Function
